...
public class newHttpUtils {
    ...
    //存储APIkey
    public static final String API_KEY = "free";
    //存储接口请求地址
    public static final String API_URL = "http://api.qingyunke.com/api.php";
    ...
    private static String setParameter(String msg) {
        ...
        try {
            return API_URL + "?key=" + API_KEY + "&msg=" + URLEncoder.encode(msg, "utf-8");
